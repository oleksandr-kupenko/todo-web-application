...
const FilterSearch = (props) => {
  let { filterValue, searchValue, setfilterValue, setSearchValue, sorthValue, seteSortValue } = props;
  ...
  return (
    <div className="filterBlock">
      ...
      <div className="filter">
        <select name="sortTodos" onClick={handleChangeFilter} defaultValue={filterValue}>
